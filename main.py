...
QUIZ_QUESTIONS = [
   {
    ...
    "instructions": "Click on the piece that is the BLOCKER — the piece that should move to reveal the hidden attacker.",
    ...
    "correct_message": "Correct! The knight on e4 is the blocker — moving it reveals the bishop on g2's long diagonal, attacking the rook on a8!",
    "board_theme": "green",
    "pieces": {
        "a8": "bR", "h8": "bR",
        "c7": "bP", "d7": "bP", "f7": "bP",
    ...
    "category": "Identification",
    "title": "Identify the Blocking Piece",
    "instructions": "Click on the piece that is the BLOCKING PIECE — the piece that should move to reveal the hidden attacker.",
    "hint": "Look for pieces near open lanes to target pieces.",
    "answer_square": "e2",
    "wrong_message": "Not quite! That piece doesn't open up a line for a hidden attacker. Try looking for a piece blocking a rook, bishop, or queen.",
    ...
    #this one is not setup correctly
        ...
        "category": "Spot the Opponent's Attack",
        "title": "Spot the Opponent's Attack!",
        "instructions": "Find the white piece that should move to unleash a discovered attack — it can even capture on its way!",
        ...
        "correct_message": "Correct! The knight on e5 is the blocking piece — moving it to take the pawn on c6 allows it to capture a piece while threatening the black bishop on e7!",
        "board_theme": "green",
        "perspective": "black",
        "pieces": {
            "a8": "bR", "d8": "bR",
    ...
    },
   {
    ...
    "title": "Identify the Blocking Piece",
    "instructions": "Find the white piece that creates a discovered attack — the moving piece should create one threat while revealing a second threat behind it.",
